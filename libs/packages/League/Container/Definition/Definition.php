...
namespace CollectReviews\Vendor\League\Container\Definition;

use CollectReviews\Vendor\League\Container\Argument\{
    ArgumentResolverInterface,
    ArgumentResolverTrait,
    ArgumentInterface,
    LiteralArgumentInterface
};
use CollectReviews\Vendor\League\Container\ContainerAwareTrait;
use CollectReviews\Vendor\League\Container\Exception\ContainerException;
